# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01_Core/03_oas_to_schema.ipynb.

# %% auto 0
__all__ = ['MIME_TYPES', 'TRANSFERABLE_TYPES', 'load_oas', 'retrieve_ref_parts', 'extract_refs', 'transform_property',
           'generate_request', 'api_schema']

# %% ../../nbs/01_Core/03_oas_to_schema.ipynb 3
import copy
import json
import os
import re
...
# %% ../../nbs/01_Core/03_oas_to_schema.ipynb 6
def load_oas(
...
# %% ../../nbs/01_Core/03_oas_to_schema.ipynb 13
MIME_TYPES = {
    "text": [
        "plain",
        "html",
...
# %% ../../nbs/01_Core/03_oas_to_schema.ipynb 15
def extract_refs(
...
# %% ../../nbs/01_Core/03_oas_to_schema.ipynb 22
...
# %% ../../nbs/01_Core/03_oas_to_schema.ipynb 30
...
# %% ../../nbs/01_Core/03_oas_to_schema.ipynb 33
def api_schema(
