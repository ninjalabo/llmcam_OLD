# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/Core/03_oas_to_requests.ipynb.

# %% auto 0
__all__ = ['MIME_TYPES', 'TRANSFERABLE_TYPES', 'retrieve_ref_parts', 'extract_refs', 'transform_property', 'generate_request',
           'api_schema']

# %% ../../nbs/Core/03_oas_to_requests.ipynb 3
import requests
...
# %% ../../nbs/Core/03_oas_to_requests.ipynb 7
MIME_TYPES = {
    "text": [
        "plain",
        "html",
...
# %% ../../nbs/Core/03_oas_to_requests.ipynb 8
def extract_refs(
...
# %% ../../nbs/Core/03_oas_to_requests.ipynb 15
...
# %% ../../nbs/Core/03_oas_to_requests.ipynb 22
...
# %% ../../nbs/Core/03_oas_to_requests.ipynb 27
def api_schema(
