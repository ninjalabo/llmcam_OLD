...
# %% auto 0
__all__ = ['session_messages', 'session_tools', 'session_noti_sender', 'default_tools', 'hdrs', 'app', 'noti_script',
           'scroll_script', 'title_script', 'prepare_handler_schemas', 'execute_handler', 'init_session', 'ChatMessage',
           'ChatInput', 'ActionButton', 'ActionPanel', 'ToolPanel', 'NotiMessage', 'NotiButton', 'index',
           'noti_disconnect', 'wsnoti', 'chat_disconnect', 'wschat', 'get_file', 'llmcam_chatbot']
...
session_noti_sender = {}  # Notification sender for each session
...
async def wsnoti(ws, send, session_id: str):
    ...
    session_noti_sender[session_id] = send_noti
