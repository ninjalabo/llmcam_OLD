...
# %% auto 0
__all__ = ['YTLiveTools', 'session_tools', 'execute_handler', 'hdrs', 'app', 'scroll_script', 'ChatMessage', 'ChatInput',
...
from .store import execute_handler_core, setup_fixup, initialize_handlers
...
session_tools = {}
execute_handler = setup_fixup(
    fixup_core=execute_handler_core, 
    fixup_name="execute_handler", 
    with_session=True,
