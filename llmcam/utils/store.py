...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_Utils/01_store.ipynb.

# %% auto 0
__all__ = ['add_function_tools', 'add_api_tools', 'remove_tools', 'execute_handler_core', 'handler_schema']

# %% ../../nbs/02_Utils/01_store.ipynb 5
...
# %% ../../nbs/02_Utils/01_store.ipynb 12
def add_api_tools(
    tools: list,  # List of existing tools
...
# %% ../../nbs/02_Utils/01_store.ipynb 17
def remove_tools(
    tools: list,  # List of existing tools
    service_name: str  # Name of the service
):
...
# %% ../../nbs/02_Utils/01_store.ipynb 20
...
# %% ../../nbs/02_Utils/01_store.ipynb 21
def handler_schema(
